...
public class UserServiceImpl implements UserService {
    ...
    public User registerUser(User user) {
        ...
        emailSenderService.sendEmail(user.getEmail(), "Activate Your Account", buildActivationEmail(user.getFirstName(), link));
    ...
    public User forgotPassword(String email) {
        ...
        emailSenderService.sendEmail(email, "Reset Password", buildForgotPasswordEmail(user.getFirstName(), link));
